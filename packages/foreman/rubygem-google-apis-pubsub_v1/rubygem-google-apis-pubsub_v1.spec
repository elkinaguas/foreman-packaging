...
%description
This is the simple REST client for Cloud Pub/Sub API V1. Simple REST clients
...
and logging. You can use this client to access the Cloud Pub/Sub API, but note
...
%changelog
* Sun Oct 09 2022 Foreman Packaging Automation <packaging@theforeman.org> 0.29.0-1
- Update to 0.29.0

* Wed Jul 13 2022 Ewoud Kohl van Wijngaarden <ewoud@kohlvanwijngaarden.nl> 0.23.0-1
- Add rubygem-google-apis-pubsub_v1 generated by gem2rpm using the default template
